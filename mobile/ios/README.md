...
```bash
# 下载代码
mkdir -p ~/go/src/github.com/FISCO-BCOS && cd ~/go/src/github.com/FISCO-BCOS && git clone https://github.com/realcoooool/fiscov3-sdk.git && cd go-sdk
# 切换到develop分支
...
```bash
# 编译iOS SDK，当前目录~/go/src/github.com/realcoooool/fiscov3-sdk
...
```bash
# 当前目录~/go/src/github.com/realcoooool/fiscov3-sdk
...
```bash
# 当前目录~/go/src/github.com/realcoooool/fiscov3-sdk/helloworld
# 下载编译器
...
```bash
# 当前位置 ~/go/src/github.com/realcoooool/fiscov3-sdk/helloworld
