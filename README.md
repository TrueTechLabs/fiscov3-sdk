...
适配FISCO-BCOS v3 / [适配FISCO-BCOS v2](https://github.com/realcoooool/fiscov3-sdk/tree/master-FISCO-BCOS-v2)
...
[![Code Lines](https://tokei.rs/b1/github/FISCO-BCOS/go-sdk?category=code)](https://github.com/realcoooool/fiscov3-sdk)
[![version](https://img.shields.io/github/tag/FISCO-BCOS/go-sdk.svg)](https://github.com/realcoooool/fiscov3-sdk/releases/latest)

![FISCO-BCOS Go-SDK GitHub Actions](https://github.com/realcoooool/fiscov3-sdk/workflows/FISCO-BCOS%20Go-SDK%20GitHub%20Actions/badge.svg)
...
- 对应FISCO BCOS v2, 请参考[此分支](https://github.com/realcoooool/fiscov3-sdk/tree/master-FISCO-BCOS-v2)，[对应文档](https://fisco-bcos-documentation.readthedocs.io/zh_CN/latest/docs/sdk/go_sdk/index.html)
...
```bash
git clone https://github.com/realcoooool/fiscov3-sdk.git
cd go-sdk
go mod tidy
...
```go
import "github.com/realcoooool/fiscov3-sdk/client"
```
...
import (
    ...
    "github.com/realcoooool/fiscov3-sdk/hello"
)
